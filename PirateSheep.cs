...
namespace Server.Mobiles
{
    ...
    public class ButtPirateSheep : BaseCreature, ICarvable
    {
        private DateTime m_NextWoolTime;
        [Constructable]
        public ButtPirateSheep()
            : base(AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            this.Name = "a scared sheep";
            this.Body = 0xCF;
        ...
        public ButtPirateSheep(Serial serial)
            : base(serial)
        {
        }
        ...
        public void Carve(Mobile from, Item item)
        {
            ...
            {
                // This ButtPirateSheep is not yet ready to be shorn.
