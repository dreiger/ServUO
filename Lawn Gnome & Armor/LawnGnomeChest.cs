...
// Created On: 12/17/2015 9:03:09 PM
// By: dave
...
{
    public class LawnGnomeChest : DragonChest
    {
        ...
        [Constructable]
        public LawnGnomeChest()
        {
            Name = "Lawn Gnome Chest";
            Hue = 2431;
        ...
        public LawnGnomeChest(Serial serial) : base( serial )
        {
        }
