...
// Created On: 12/17/2015 9:06:41 PM
// By: dave
...
{
    public class LawnGnomePoker : Longsword
    {
        ...
        [Constructable]
        public LawnGnomePoker()
        {
            Name = "Lawn Gnome Poker";
            Hue = 2431;
        ...
        public LawnGnomePoker(Serial serial) : base( serial )
        {
        }
