...
// Created On: 12/17/2015 9:03:22 PM
// By: dave
...
{
    public class LawnGnomeLegs : DragonLegs
    {
        ...
        [Constructable]
        public LawnGnomeLegs()
        {
            Name = "Lawn Gnome Legs";
            Hue = 2431;
        ...
        public LawnGnomeLegs(Serial serial) : base( serial )
        {
        }
