...
// Created On: 12/17/2015 9:03:34 PM
// By: dave
...
{
    public class LawnGnomeArms : DragonArms
    {
        ...
        [Constructable]
        public LawnGnomeArms()
        {
            Name = "Lawn Gnome Arms";
            Hue = 2431;
        ...
        public LawnGnomeArms(Serial serial) : base( serial )
        {
        }
