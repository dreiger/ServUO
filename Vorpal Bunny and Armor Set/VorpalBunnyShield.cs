...
// Created On: 12/13/2015 9:26:28 AM
// By: dave
...
{
    public class VorpalBunnyShield : OrderShield
    {
        ...
        [Constructable]
        public VorpalBunnyShield()
        {
            Name = "Vorpal Bunny Shield";
            Hue = 0x480;
            StrRequirement = 45;
            DexRequirement = 45;
            IntRequirement = 45;
            ...
            SkillBonuses.SetValues( 0, SkillName.Chivalry, 45.0 );
            SkillBonuses.SetValues( 1, SkillName.Necromancy, 45.0 );
            SkillBonuses.SetValues( 2, SkillName.Spellweaving, 45.0 );
            SkillBonuses.SetValues( 3, SkillName.SpiritSpeak, 45.0 );
        }

        public VorpalBunnyShield(Serial serial) : base( serial )
        {
        }
