...
{
	[CorpseName( "a godly dragon corpse" )]
	public class GodlyDragon : BaseCreature
	{
		[Constructable]
		public GodlyDragon () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a godly dragon";
      ...
      Hue = 1663;
		...
		public GodlyDragon( Serial serial ) : base( serial )
		{
		}
