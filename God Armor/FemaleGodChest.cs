...
// Created On: 12/4/2015 10:58:21 PM
// By: dave
...
{
    public class FemaleGodChest : FemalePlateChest
    {
        ...
        [Constructable]
        public FemaleGodChest()
        {
            Name = "Female Godly Armor";
            Hue = 32;
            StrRequirement = 70;
            DexRequirement = 70;
            IntRequirement = 70;
        ...
        public FemaleGodChest(Serial serial) : base( serial )
        {
        }
