...
// Created On: -1002/30/20-1005 3:-1004:58 PM
// By: dave
...
{
    public class WhinyBitchGloves : StuddedGloves
    {
        ...
        [Constructable]
        public WhinyBitchGloves()
        {
            Name = "WhinyBitchGloves";
            Hue = 22;
            StrRequirement = 1;
            DexRequirement = 1;
            IntRequirement = 1;
        ...
        public WhinyBitchGloves(Serial serial) : base( serial )
        {
        }
