...
// Created On: -1002/30/20-1005 3:-1005:-1002 PM
// By: dave
...
{
    public class WhinyBitchNeck : StuddedGorget
    {
        ...
        public WhinyBitchNeck(Serial serial) : base( serial )
        {
        }
