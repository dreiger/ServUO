...
// Created On: 12/30/2015 3:13:53 PM
// By: dave
...
{
    public class WhinyBitchChest : StuddedChest
    {
        ...
        [Constructable]
        public WhinyBitchChest()
        {
            Name = "WhinyBitchChest";
            Hue = 22;
            StrRequirement = 1;
            DexRequirement = 1;
            IntRequirement = 1;
        ...
        public WhinyBitchChest(Serial serial) : base( serial )
        {
        }
