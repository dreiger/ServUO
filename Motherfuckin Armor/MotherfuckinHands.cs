...
// Created On: 11/29/2015 10:49:56 PM
// By: dave
...
{
    public class MotherfuckinHands : LeatherGloves
    {
        ...
        [Constructable]
        public MotherfuckinHands()
        {
            Name = "MotherfuckinHands";
            Hue = 666;
        ...
        public MotherfuckinHands(Serial serial) : base( serial )
        {
        }
