...
// Created On: 11/29/2015 10:49:31 PM
// By: dave
...
{
    public class MotherfuckinChest : LeatherChest
    {
        ...
        [Constructable]
        public MotherfuckinChest()
        {
            Name = "MotherfuckinChest";
            Hue = 666;
        ...
        public MotherfuckinChest(Serial serial) : base( serial )
        {
        }
