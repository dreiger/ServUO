...
// Created On: 11/29/2015 10:50:35 PM
// By: dave
...
{
    public class MotherfuckinLegs : LeatherLegs
    {
        ...
        [Constructable]
        public MotherfuckinLegs()
        {
            Name = "MotherfuckinLegs";
            Hue = 666;
        ...
        public MotherfuckinLegs(Serial serial) : base( serial )
        {
        }
