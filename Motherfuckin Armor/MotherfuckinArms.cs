...
// Created On: 11/29/2015 10:50:58 PM
// By: dave
...
{
    public class MotherfuckinArms : LeatherArms
    {
        ...
        [Constructable]
        public MotherfuckinArms()
        {
            Name = "MotherfuckinArms";
            Hue = 666;
        ...
        public MotherfuckinArms(Serial serial) : base( serial )
        {
        }
