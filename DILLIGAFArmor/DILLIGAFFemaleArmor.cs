...
// Created On: 9/3/2016 11:42:38 AM
// By: daver
...
{
    public class DILLIGAFFemaleArmor : FemaleLeatherChest
    {
        ...
        [Constructable]
        public DILLIGAFFemaleArmor()
        {
            Name = "DILLIGAFFemaleArmor";
            Hue = 2431;
            StrRequirement = 25;
            DexRequirement = 25;
            IntRequirement = 25;
        ...
        public DILLIGAFFemaleArmor(Serial serial) : base( serial )
        {
        }
