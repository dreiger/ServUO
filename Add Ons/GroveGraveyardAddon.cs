...
namespace Server.Items
{
	public class GroveGraveYardAddon : BaseAddon
	{
		...
		public GroveGraveYardAddon()
		{
			...
			AddComplexComponent( (BaseAddon) this, 3800, -4, -4, 0, 1910, -1, "Here Lays Joker", 1);// 42
			AddComplexComponent( (BaseAddon) this, 3799, -5, 4, 0, 2069, -1, "Here Lays BangPowBoom", 1);// 45
			AddComplexComponent( (BaseAddon) this, 3799, -5, 2, 0, 1919, -1, "Here Lays Ennina", 1);// 51
			AddComplexComponent( (BaseAddon) this, 3800, -2, -4, 0, 1919, -1, "Here Lays Cakemonkillr", 1);// 56
			AddComplexComponent( (BaseAddon) this, 3800, 0, -4, 0, 2075, -1, "Here Lays Havoc", 1);// 72
			AddComplexComponent( (BaseAddon) this, 3800, 2, -4, 0, 2070, -1, "Here Lays DrathX", 1);// 105
			AddComplexComponent( (BaseAddon) this, 3800, 4, -4, 0, 2071, -1, "Here Lays Linked The Hidden-", 1);// 106
