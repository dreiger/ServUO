...
namespace Server.Items
{
	public class FirepitAddon : BaseAddon
	{
		...
		{
			Tuple.Create(10749, new Point3D(0, 0, 0), 1, 0, 0, (string)null), // 1
			Tuple.Create(6571, new Point3D(0, 0, 5), 1, 0, 0, (string)null) // 2
		};
		
		public override BaseAddonDeed Deed { get { return new FirepitAddonDeed(); } }
	...
	public class FirepitAddonDeed : BaseAddonDeed
	{
		...
		public FirepitAddonDeed(Serial serial) 
			: base(serial)
		{ }
