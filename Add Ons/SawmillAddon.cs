...
namespace Server.Items
{
    public class SawmillBlade : AddonComponent
    {
        ...
        {
            Name = "A dangerous looking saw blade (it's a sharp spinny thing)";
        }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            {
                from.SendMessage(89, "You're too far away from the spinning blade to do any damage.");
            }
            else
            {
                from.SendMessage(89, "Doh!  You Almost loose a finger !!!");
    ...
    public class SawmillSign : AddonComponent
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            from.SendMessage(89, "Don't play with the blade, or yourself.");
        }
    ...
    public class SawmillCrate : AddonComponent
    {
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            ...
            else
            {
                ...
                from.SendMessage(89, "This can only cut logs (and your fingers, dumbass).");
                return false;
            }
            return false;
        }
