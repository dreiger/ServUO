...
{
    [CorpseName("a Paragon Devourer of souls corpse")]
    public class ParagonDevourer : BaseCreature
    {
        [Constructable]
        public ParagonDevourer()
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            this.Name = "a Paragon Devourer of souls";
            this.Body = 303;
        ...
        public ParagonDevourer(Serial serial)
            : base(serial)
        {
        }
