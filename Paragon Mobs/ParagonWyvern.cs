...
{
    [CorpseName("a ParagonWyvern corpse")]
    public class ParagonWyvern : BaseCreature
    {
        [Constructable]
        public ParagonWyvern()
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            this.Name = "a Paragon Wyvern";
            this.Body = 62;
        ...
        public ParagonWyvern(Serial serial)
            : base(serial)
        {
        }
