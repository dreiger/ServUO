...
{
    [CorpseName("a dead freakin dragon")]
    public class ParagonAncientWyrm : BaseCreature
    {
        [Constructable]
        public ParagonAncientWyrm()
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            this.Name = "a paragon ancient wyrm";
            this.Body = 46;
        ...
        public ParagonAncientWyrm(Serial serial)
            : base(serial)
        {
        }
