...
{
    [CorpseName("a ParagonScorpion corpse")]
    public class ParagonScorpion : BaseCreature
    {
        [Constructable]
        public ParagonScorpion()
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            this.Name = "a ParagonScorpion";
            this.Body = 48;
        ...
        public ParagonScorpion(Serial serial)
            : base(serial)
        {
        }
