...
{
    [CorpseName("a Paragon Golem corpse")]
    public class ParagonGolem : BaseCreature
    {
        ...
        [Constructable]
        public ParagonGolem(bool summoned, double scalar)
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.4, 0.8)
        {
            this.Name = "a Paragon Golem";
            this.Body = 752;
            this.IsParagon = true;
        ...
        public ParagonGolem(Serial serial)
            : base(serial)
        {
        }
