...
namespace Server.Mobiles
{
    ...
    public class ParagonBladeSpirits : BaseCreature
    {
        [Constructable]
        public ParagonBladeSpirits()
        ...
        public ParagonBladeSpirits(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void OnThink()
        {
            if (Core.SE && this.Summoned)
            {
                ...
                {
                    if (m is EnergyVortex || m is ParagonBladeSpirits)
                    {
