...
{
    [CorpseName("a Paragon Centaur corpse")]
    public class ParagonCentaur : BaseCreature
    {
        [Constructable]
        public ParagonCentaur()
            : base(AIType.AI_Melee, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            this.Name = NameList.RandomName("Paragon Centaur");
            this.Body = 101;
        ...
        public ParagonCentaur(Serial serial)
            : base(serial)
        {
        }
