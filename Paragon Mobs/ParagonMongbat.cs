...
{
    [CorpseName("a ParagonMongbat corpse")]
    public class ParagonMongbat : BaseCreature
    {
        [Constructable]
        public ParagonMongbat()
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            this.Name = "a Paragon Mongbat";
            this.Body = 39;
        ...
        public ParagonMongbat(Serial serial)
            : base(serial)
        {
        }
