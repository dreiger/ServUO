...
{
	public class ParagonRevenant : BaseCreature
	{
		private readonly Mobile m_Target;
		private readonly DateTime m_ExpireTime;

		public ParagonRevenant(Mobile caster, Mobile target, TimeSpan duration)
			: base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.18, 0.36)
		{
			Name = "a Paragon Revenant";
			Body = 400;
			Hue = 1;
			IsParagon = true;
			// TODO: Sound values?
		...
		public ParagonRevenant(Serial serial)
			: base(serial)
		{ }
