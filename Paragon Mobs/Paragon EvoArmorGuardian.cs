...
namespace Server.Mobiles
{
	...
	public class ParagonEvoArmorGuardian : BaseCreature
	{
		public override bool ShowFameTitle{ get{ return false; } }

		[Constructable]
		public ParagonEvoArmorGuardian() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "Paragon Evo Guardian";
			Body = 311;
			Hue = 0;
      BaseSoundID = 1072;
      IsParagon = true;
		...
		public ParagonEvoArmorGuardian( Serial serial ) : base( serial )
		{
		}
