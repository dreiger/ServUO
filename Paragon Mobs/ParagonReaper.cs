...
{
    [CorpseName("a ParagonReapers corpse")]
    public class ParagonReaper : BaseCreature
    {
        [Constructable]
        public ParagonReaper()
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            this.Name = "a ParagonReaper";
            this.Body = 47;
        ...
        public ParagonReaper(Serial serial)
            : base(serial)
        {
        }
