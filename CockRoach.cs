...
{
	[CorpseName( "a dead cockroach" )]
	public class CockRoach : BaseMount
	{
		[Constructable]
		public CockRoach() : this( "a cockroach" )
		{
		}
		...
		[Constructable]
		public CockRoach( string name ) : base( name, 0x317, 0x3EBC, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			SetStr( 000 );
			SetDex( 110 );
			SetInt( 500 );
