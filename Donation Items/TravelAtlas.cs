...
namespace Server.Items
{
	public class TravelAtlas : Item
	{
		...
		public static void Initialize()
		{
			...
			//	new TAEntry("Egypt Dungeon", new Point3D(6116, 484, 0), Map.Trammel ),
			//	new TAEntry("Paragon Champ Room", new Point3D(6370, 734, 0), Map.Trammel ),
			//	new TAEntry("Flaming Pirate Dungeon", new Point3D(5950, 446, 22), Map.Trammel ),
				new TAEntry("Lawn Gnome Dungeon", new Point3D(5217, 1291, 0), Map.Trammel ) */
				new TAEntry("Blighted Grove", new Point3D(586, 1643, -5), Map.Trammel ),
				new TAEntry("Covetous", new Point3D(2498, 921, 0), Map.Trammel ),
				new TAEntry("Daemon Temple", new Point3D(4591, 3647, 80), Map.Trammel ),
				new TAEntry("Deceit", new Point3D(4111, 434, 5), Map.Trammel ),
				new TAEntry("Despise", new Point3D(1301, 1080, 0), Map.Trammel ),
				...
				new TAEntry("Ophidian Temple", new Point3D(5766, 2634, 43), Map.Trammel ),
				new TAEntry("Orc Caves", new Point3D(1017, 1429, 0), Map.Trammel ),
				new TAEntry("Painted Caves", new Point3D(1716, 2993, 0), Map.Trammel ),
				new TAEntry("Paroxysmus", new Point3D(5569, 3019, 31), Map.Trammel ),
				new TAEntry("Prism of Light", new Point3D(3789, 1095, 20), Map.Trammel ),
				new TAEntry("Sanctuary", new Point3D(759, 1642, 0), Map.Trammel ),
				new TAEntry("Shame", new Point3D(511, 1565, 0), Map.Trammel ),
			//	new TAEntry("Solen Hive", new Point3D(2607, 763, 0), Map.Trammel ),
			//	new TAEntry("Terathan Keep", new Point3D(5451, 3143, -60), Map.Trammel ),
				new TAEntry("Wrong", new Point3D(2043, 238, 10), Map.Trammel ),
				new TAEntry("Egyption Dungeon", new Point3D(5571, 1301, 0), Map.Trammel ),
				new TAEntry("Lawn Gnome Dungeon", new Point3D(5217, 1291, 0), Map.Trammel )
			});
			...
			GlobalEntries.Add("Felucca Dungeons", new TAEntry[]
			{
				...
				new TAEntry("Paragon Dungeon", new Point3D(6033, 353, 44), Map.Felucca ),
				new TAEntry("Minotaur's Maze", new Point3D(5378, 1250, 0), Map.Felucca )
			//	new TAEntry("Hell", new Point3D(5377, 1258, 0), Map.Felucca )
			});

			GlobalEntries.Add("Custom Areas", new TAEntry[]//add locations to the Custom map here
			{
			//	new TAEntry("Rich Bitch Hill", new Point3D(1366, 1370, 0), Map.Trammel ),
				new TAEntry("Training Room", new Point3D(5534, 1082, 0), Map.Trammel ),
				new TAEntry("Lawn Gnome Dungeon", new Point3D(5217, 1291, 30), Map.Trammel ),
				new TAEntry("Player Vendor Mall", new Point3D(5916, 542, 0), Map.Trammel ),
				new TAEntry("Hedge Maze", new Point3D(1216, 2199, 5), Map.Trammel ),
				new TAEntry("Brit Cow Pen", new Point3D(1308, 1803, 0), Map.Trammel ),
				new TAEntry("Hue Room", new Point3D(5889, 577, 0), Map.Trammel ),
			//	new TAEntry("Taming Forest", new Point3D(902, 912, 0), Map.Trammel ),
			//	new TAEntry("Champ Room", new Point3D(6370, 734, 0), Map.Trammel ),
				new TAEntry("Arti Display Room", new Point3D(5279, 1069, 5), Map.Trammel ),
				new TAEntry("Donation Room", new Point3D(5212, 1755, 0), Map.Trammel ),
				new TAEntry("Brit Hedge Maze", new Point3D(1216, 2199, 5), Map.Trammel ),
				new TAEntry("Supply Room", new Point3D(5168, 1182, 0), Map.Trammel ),
				new TAEntry("Event Area", new Point3D(5379, 1274, 0), Map.Trammel )
			});
			...
			GlobalEntries.Add("Staff", new TAEntry[]//add locations to the staff map here
			{
				...
				new TAEntry("Staff Office", new Point3D(5398, 1115, 0), Map.Trammel ),
				new TAEntry("Start Room", new Point3D(5398, 1115, 0), Map.Trammel ),
				new TAEntry("GM Office 1", new Point3D(5398, 1115, 0), Map.Trammel ),
				new TAEntry("GM Office 2", new Point3D(5398, 1115, 0), Map.Trammel ),
				new TAEntry("GM Office 3", new Point3D(5398, 1115, 0), Map.Trammel ),
				new TAEntry("GM Office 4", new Point3D(5398, 1115, 0), Map.Trammel ),
				new TAEntry("The Test Pit", new Point3D(5394, 1110, 0), Map.Trammel ),
				new TAEntry("Odin's Fuckin House", new Point3D(5386, 1118, 0), Map.Felucca )
			});
	...
	public class TravelAtlasGump : Gump
	{
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			else if ( !from.InRange( m_TravelAtlas.GetWorldLocation(), 0 ) || from.Map != m_TravelAtlas.Map )
