...
{
	public class TcScroll : Item
	{
		[Constructable]
		public TcScroll() : base( 5360 )
		{
			base.Weight = 1.0;
			base.Name = "An Ancient Tamers Scroll +1 Followers";
            		base.Hue = 0x481;
			LootType = LootType.Cursed;
		}

		public TcScroll( Serial serial ) : base( serial )
		{
		}
		...
		PlayerMobile mobile = from as PlayerMobile;
		 ...
		 { 
			...
			else
			{
			  	...
			  	mobile.SendMessage( "You have gained 1 to your maximum control slots." );
