...
// Created On: 11/29/2015 10:51:38 PM
// By: dave
...
{
    public class DonationFemaleArmor : FemaleLeatherChest
    {
        ...
        [Constructable]
        public DonationFemaleArmor()
        {
            Name = "Donation Female Armor";
            Hue = 2637;
        ...
        public DonationFemaleArmor(Serial serial) : base( serial )
        {
        }
