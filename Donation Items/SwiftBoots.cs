...
namespace Server.Items
{
	class SwiftBoots : BaseArmor
	{
		...
		private static readonly TimeSpan UsageInterval = new TimeSpan(0, 0, 30, 0);
		// Effect lasts for 1 minute by default
		private static readonly TimeSpan EffectDuration = new TimeSpan(0, 0, 10, 0);
		// Hue of the boots
		...
		public override bool OnEquip( Mobile from )
		{
			...
			{
				from.SendMessage(38, "You need to wait for 30 minutes until the magic recharges.");
			}
