...
namespace Server.Items
{
   public class PetSlotStatue : Item
   {
      ...
      {
         base.Weight = 1.0;
         base.Name = "[Donation Item]A Pet Slot +1 Statue - +14 Followers MAX";
         base.Hue = 0x8A;
      ...
      PlayerMobile mobile = from as PlayerMobile;
       ...
       { 
         ...
         else if ( mobile.FollowersMax >= 14 )
         {
            mobile.SendMessage( "You are not allowed more than 14 pet slots." );
         }
         else
         {
