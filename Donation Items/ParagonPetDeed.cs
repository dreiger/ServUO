...
{ 
   	public class ParagonPetDeed : Item 
   	{ 
  		...
  		private class BondTarget : Target 
      		{ 
         		...
         		private ParagonPetDeed m_Powder; 

         		public BondTarget( ParagonPetDeed charge ) : base ( 10, false, TargetFlags.None ) 
         		{ 
            			m_Powder=charge; 
         		} 
