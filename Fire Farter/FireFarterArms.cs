...
// Created On: 12/22/2015 6:37:40 PM
// By: dave
...
{
    public class FireFarterArms : RingmailArms
    {
        ...
        [Constructable]
        public FireFarterArms()
        {
            Name = "Fire Farter Arms";
            Hue = 1976;
            StrRequirement = 5;
            DexRequirement = 5;
            IntRequirement = 5;
        ...
        public FireFarterArms(Serial serial) : base( serial )
        {
        }
