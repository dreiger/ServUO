...
// Created On: 12/22/2015 6:37:53 PM
// By: dave
...
{
    public class FireFarterGloves : RingmailGloves
    {
        ...
        [Constructable]
        public FireFarterGloves()
        {
            Name = "Fire Farter Gloves";
            Hue = 1976;
            StrRequirement = 5;
            DexRequirement = 5;
            IntRequirement = 5;
        ...
        public FireFarterGloves(Serial serial) : base( serial )
        {
        }
