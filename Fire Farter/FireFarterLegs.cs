...
// Created On: 12/22/2015 6:37:24 PM
// By: dave
...
{
    public class FireFarterLegs : RingmailLegs
    {
        ...
        [Constructable]
        public FireFarterLegs()
        {
            Name = "Fire Farter Legs";
            Hue = 1976;
            StrRequirement = 5;
            DexRequirement = 5;
            IntRequirement = 5;
        ...
        public FireFarterLegs(Serial serial) : base( serial )
        {
        }
