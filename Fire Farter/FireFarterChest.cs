...
// Created On: 12/22/2015 6:37:03 PM
// By: dave
...
{
    public class FireFarterChest : RingmailChest
    {
        ...
        [Constructable]
        public FireFarterChest()
        {
            Name = "Fire Farter Chest";
            Hue = 1976;
            StrRequirement = 5;
            DexRequirement = 5;
            IntRequirement = 5;
        ...
        public FireFarterChest(Serial serial) : base( serial )
        {
        }
