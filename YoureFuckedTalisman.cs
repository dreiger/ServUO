...
{
        public class YoureFuckedTalisman : Item
        {
                ...
                [Constructable]
                public YoureFuckedTalisman(): base( 0x2F59 )
                {
			Name = "Good luck removing this - you're fucked.";
                        LootType = LootType.Blessed;
                        Movable = false;
			Layer = Layer.Mount;
                }

                public YoureFuckedTalisman( Serial serial ) : base( serial )
                {
                }
