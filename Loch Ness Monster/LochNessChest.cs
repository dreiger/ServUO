...
// Created On: 10/26/2016 8:01:58 AM
// By: daver
...
{
    public class LochNessChest : RingmailChest
    {
        ...
        [Constructable]
        public LochNessChest()
        {
            Name = "Loch Ness Chest";
            Hue = 2431;
        ...
        public LochNessChest(Serial serial) : base( serial )
        {
        }
